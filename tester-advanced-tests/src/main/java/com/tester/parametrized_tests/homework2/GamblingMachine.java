...
public class GamblingMachine {
    public int howManyWins(Set<Integer> userNumbers) throws InvalidNumbersExceptions {
    ...
    private void validateNumbers(Set<Integer> numbers) throws InvalidNumbersExceptions {
        if (isNotCorrectSize(numbers) || isAnyNumberOutOfDeclaredScope(numbers)) {
            throw new InvalidNumbersExceptions();
        }
    }
